  ...
  <div class="max-w-screen-xl mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex flex-col md:flex-row items-center justify-between py-4 gap-4">
      ...
      <div class="flex items-center gap-4">
        <img src="/logo.png" alt="Logo Pemadam Kebakaran" class="w-14 h-14 object-contain" />
      ...
      <nav class="w-full md:w-auto">
        <ul class="flex flex-wrap justify-center md:justify-end gap-4 md:gap-6 text-sm md:text-base">
          ...
          <li><a href="{{ route('Kontak') }}" class="block p-2 rounded hover:bg-red-800 transition">Kontak</a></li>
        </ul>
      </nav>
