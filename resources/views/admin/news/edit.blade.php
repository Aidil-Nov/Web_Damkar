    ...
    <div class="container max-w-4xl mx-auto">
        ...
        <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="title" id="judul" value="{{ old('title', $news->title) }}"
            ...
            <!-- Input for Published Date -->
            <div class="mb-4">
                <label for="published_at" class="block text-sm font-medium text-gray-700">Tanggal Upload</label>
            ...
            <div class="mb-4">
                ...
                <a href="{{ route('admin.news.index') }}"
                    class="ml-3 px-4 py-2 bg-gray-500 text-white rounded hover:bg-gray-600">Kembali</a>
            </div>
        </form>
    </div>
@endsection
